...
const LINK_CLASS =
  "text-[11px] font-medium tracking-[0.18em] text-muted uppercase transition-colors hover:text-foreground focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-nav focus-visible:outline-none xl:text-xs 2xl:text-[13px]";
...
export default function SiteNav() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-line bg-nav/95 backdrop-blur">
      <nav
        aria-label="Primary"
        className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8 xl:h-20 xl:max-w-7xl 2xl:h-[5.5rem] 2xl:max-w-[96rem]"
      >
        <a
          href={brand.homeHref}
          className="font-display shrink-0 text-sm font-bold tracking-[0.2em] whitespace-nowrap text-foreground xl:text-base 2xl:text-lg"
        >
          {brand.wordmark}
        </a>
